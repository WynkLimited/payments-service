...
public class TransactionAwareAspect {
    ...
    @Around(value = "execution(@in.wynk.payment.aspect.advice.TransactionAware * *.*(..))")
    public Object TransactionAwareAround(ProceedingJoinPoint joinPoint) throws Throwable {
        Object returnObj;
        ...
        String txnId = transactionAware.txnId();
