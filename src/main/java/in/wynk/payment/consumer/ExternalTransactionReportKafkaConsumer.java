...
public class ExternalTransactionReportKafkaConsumer extends AbstractKafkaEventConsumer<String, ExternalTransactionReportMessageManager> {
    ...
    protected void listenExternalTransactionReportMessageManager(@Header(value = StreamConstant.MESSAGE_LAST_ATTEMPTED_SEQUENCE, required = false) String lastAttemptedSequence,
        ...
        try {
            ...
            log.error(StreamMarker.KAFKA_POLLING_CONSUMPTION_ERROR, "Error occurred in scheduling ExternalTransactionReportMessageManager {} due to unexpected error : {}", consumerRecord.value(), e.getMessage(), e);
        }
    }
