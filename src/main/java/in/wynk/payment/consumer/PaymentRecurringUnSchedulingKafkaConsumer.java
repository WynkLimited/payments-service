...
public class PaymentRecurringUnSchedulingKafkaConsumer extends AbstractKafkaEventConsumer<String, PaymentRecurringUnSchedulingMessage> {
    ...
    protected void listenPaymentRecurringUnSchedulingMessage(@Header(value = StreamConstant.MESSAGE_LAST_ATTEMPTED_SEQUENCE, required = false) String lastAttemptedSequence,
