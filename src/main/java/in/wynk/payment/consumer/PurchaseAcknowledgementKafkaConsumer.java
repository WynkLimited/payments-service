...
public class PurchaseAcknowledgementKafkaConsumer extends AbstractKafkaEventConsumer<String, PurchaseAcknowledgeMessageManager> {
    ...
    protected void listenPurchaseAcknowledgeMessageManager(@Header(in.wynk.scheduler.queue.constant.BeanConstant.MESSAGE_LAST_ATTEMPTED_SEQUENCE) String lastAttemptedSequence,
