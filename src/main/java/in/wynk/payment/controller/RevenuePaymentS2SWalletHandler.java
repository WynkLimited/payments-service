...
public class RevenuePaymentS2SWalletHandler {
    ...
    public WynkResponseEntity<WalletLinkResponse> linkRequest(@RequestBody S2SWalletLinkRequest request) {
    ...
    public WynkResponseEntity<Void> linkValidate(@RequestBody S2SWalletValidateLinkRequest request) {
        AnalyticService.update(request);
    ...
    public WynkResponseEntity<Void> unlink(@RequestBody S2SWalletDeLinkRequest request) {
        AnalyticService.update(request);
    ...
    public WynkResponseEntity<UserWalletDetails> balance(@RequestBody S2SWalletBalanceRequest request) {
        AnalyticService.update(request);
    ...
    public WynkResponseEntity<WalletTopUpResponse> addMoney(@RequestBody WalletTopUpRequest<S2SPurchaseDetails> request) {
        AnalyticService.update(request);
