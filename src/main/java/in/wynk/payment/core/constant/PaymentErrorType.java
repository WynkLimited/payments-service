...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PAY106("UPI Intent Txn Init API Failure", "Unable to return deeplink as PAYU API response not appropriate", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.PAYU_UPI_INIT_TXN_FAILURE),
    /**
