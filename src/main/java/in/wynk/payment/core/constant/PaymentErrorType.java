...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PAY122("Transaction failure", "Invalid msisdn", HttpStatus.NOT_FOUND, BaseLoggingMarkers.APPLICATION_INVALID_USECASE),
    ...
    PAY045("Payment Recurring removal failure", "Unable to add remove recurring", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.PAYMENT_ERROR),
