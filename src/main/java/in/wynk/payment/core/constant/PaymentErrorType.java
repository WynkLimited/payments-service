...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PAY025("Aps Recon Transaction Status Failure", "No matching status found for APS side", HttpStatus.BAD_REQUEST, PaymentLoggingMarker.PAYMENT_RECONCILIATION_FAILURE),
    ...
    PAY033("Google Play Notification Processing Failure", "No free plan mapping present for Google Play notification", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.GOOGLE_PLAY_NOTIFICATION_ERROR),
    ...
    PAY035("Amazon Iap Notification Processing Failure", "No free plan mapping present for Amazon Iap notification", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.AMAZON_IAP_NOTIFICATION_ERROR),
    ...
    PAY032("APS Pre Debit Notification Failure", "Pre Debit Notification Failed at APS side.", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.APS_PRE_DEBIT_NOTIFICATION_ERROR),
    PAY036("Payment Renewal Timeout", "Timeout occurred while making SI payment on APS", HttpStatus.REQUEST_TIMEOUT, PaymentLoggingMarker.PAYU_RENEWAL_TIMEOUT_ERROR),
    ...
    PAY045("Payment Recurring removal failure", "Unable to unschedule recurring payment", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.PAYMENT_ERROR),
    ...
    PAY442("Invoice Details Not Configured", "Invoice details not configured in mongo for the client", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.INVOICE_NOT_CONFIGURED_FOR_CLIENT),
    ...
    PAY447("Invoice callback process failed", "Invoice callback process failed, will retry", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.INVOICE_PROCESS_CALLBACK_FAILED),
    ...
    PAY602("Validation Failure", "Given payment method doesn't support auto renew. Hence, cannot create mandate", HttpStatus.BAD_REQUEST, BaseLoggingMarkers.APPLICATION_INVALID_USECASE),
