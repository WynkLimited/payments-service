...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PAYU009("PayU Callback Parse Failure", "Unable to parse the request", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.PAYU_CALLBACK_FAILURE),
    PAYU010("Payment Callback Failure", "PayU payment callback failed.", "${payment.failure.page}", HttpStatus.FOUND, PaymentLoggingMarker.PAYU_CALLBACK_FAILURE),
