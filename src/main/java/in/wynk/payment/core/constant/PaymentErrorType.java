...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PLAY005("Google Play Renewal Pipeline Failure ", "No new receipt generated by google Play for renewal", HttpStatus.BAD_REQUEST, PaymentLoggingMarker.GOOGLE_PLAY_RENEWAL_FAILURE),
