...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PLAY005("Google Play Renewal Pipeline Failure ", "Already have subscription for the corresponding google Play purchase token id", HttpStatus.NOT_FOUND, PaymentLoggingMarker.GOOGLE_PLAY_RENEWAL_FAILURE),
