...
public enum PaymentErrorType implements IWynkErrorType {
    ...
    PAY014("Verification Failure ", "Failure in validating transaction from kepler iap", HttpStatus.BAD_REQUEST, PaymentLoggingMarker.KEPLER_IAP_VERIFICATION_FAILURE),
    ...
    PAY036("Kepler Iap Notification Processing Failure", "No free plan mapping present for Kepler Iap notification", HttpStatus.INTERNAL_SERVER_ERROR,
            PaymentLoggingMarker.KEPLER_IAP_NOTIFICATION_ERROR),
    ...
    PAY026("Payment Renewal Failure", "Unable to renewal itunes subscription", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.ITUNES_RENEWAL_ERROR),
    ...
    PLAY005("Google Play Renewal Pipeline Failure ", "Google Play - Receipt not generated by Google", HttpStatus.NOT_FOUND, PaymentLoggingMarker.GOOGLE_PLAY_RENEWAL_FAILURE),
    PLAY006("Google Play Subscription Cancellation Failure ", "Could not cancel the Google Play Subscription", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.GOOGLE_PLAY_SUBSCRIPTION_CANCELLATION_FAILURE),
    PLAY007("Google Play Payment Refund Failure ", "Could not refund the Google Play payment", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.GOOGLE_PLAY_PAYMENT_REFUND_FAILURE),
    PLAY008("Google Play Renewal Failure", "Receipt entry is not Found in db While renewal", HttpStatus.NOT_FOUND, PaymentLoggingMarker.GOOGLE_PLAY_RENEWAL_FAILURE),
    ...
    PAY046("Payment Renewal Failure", "Unable to renew kepler iap subscription", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.KEPLER_IAP_RENEWAL_ERROR),
    ...
    PAYU006("PayU API Failure", "Could Not process transaction on payU", HttpStatus.INTERNAL_SERVER_ERROR, PaymentLoggingMarker.PAYU_API_FAILURE),
