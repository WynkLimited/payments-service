...
public class WebPaymentOptionsRequest implements IPaymentOptionsRequest {
    ...
    public IMiscellaneousDetails getMiscellaneousDetails() {
        ...
        return Objects.isNull(miscellaneousDetails) ? MiscellaneousDetails.builder().build() :
                MiscellaneousDetails.builder().ingressIntent(miscellaneousDetails.getIngressIntent()).autoRenew(miscellaneousDetails.isAutoRenew()).mandate(miscellaneousDetails.isMandate()).trialOpted(miscellaneousDetails.isTrialOpted()).sku(miscellaneousDetails.getSku()).build();
    }
