...
public interface ICardValidationSpec {
    ...
    /**
     * Whether a card support standing instruction to renew subscription
     */
    boolean isAutoRenew();
     ...
     * i.e. mastercard, visa, amex, cartes_bancaires, diners_club, discover, jcb, unionpay
     */
    String getBrand();
    ...
    */
    ...
    /**
    * Card Level signifies how premium a card is. i.e. PLATINUM
    */
