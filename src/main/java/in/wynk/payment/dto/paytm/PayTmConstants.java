...
public interface PayTmConstants {
    ...
    String PAYTM_STATUS_PENDING = "PENDING";
    String PAYTM_REQUEST_CUST_ID = "CUST_ID";
    String PAYTM_REQUST_ORDER_ID = "ORDER_ID";
    String PAYTM_CHECKSUMHASH = "CHECKSUMHASH";
    String PAYTM_REQUEST_TYPE = "REQUEST_TYPE";
    String PAYTM_REQUESTING_WEBSITE = "WEBSITE";
    String PAYTM_STATUS_SUCCESS = "TXN_SUCCESS";
    String PAYTM_STATUS_FAILURE = "TXN_FAILURE";
    String PAYTM_SESSION_TOKEN = "session_token";
    String PAYTM_REQUEST_TXN_AMOUNT = "TXN_AMOUNT";
