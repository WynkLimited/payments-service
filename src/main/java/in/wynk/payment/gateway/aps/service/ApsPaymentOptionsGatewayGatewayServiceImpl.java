 ...
 */
@Slf4j
public class ApsPaymentOptionsGatewayGatewayServiceImpl implements IPaymentInstrumentsGatewayProxy {
    ...
    public ApsPaymentOptionsGatewayGatewayServiceImpl(String payOptionEndpoint, ApsCommonGatewayService common) {
        this.common = common;
    ...
    public AbstractPaymentInstrumentsProxy load(String userId) {
        return new ApsPaymentInstrumentsProxy(userId);
    }
