...
import static in.wynk.payment.core.constant.PaymentErrorType.PAYU011;
    ...
    public AbstractPreDebitNotificationResponse notify (PreDebitNotificationMessage message) {
        try {
            ...
            if (response.getStatus().equalsIgnoreCase(INTEGER_VALUE)) {
                ...
                throw new WynkRuntimeException(PAYU011, response.getMessage());
            }
            ...
            throw new WynkRuntimeException(PAYU011);
        }
    }
}
