package in.wynk.payment.gateway.payu.status;
...
@Slf4j
@Service(PaymentConstants.PAYU_PAYMENT_STATUS)
public class PayUStatusGateway implements IPaymentStatusService<AbstractPaymentStatusResponse, AbstractTransactionStatusRequest> {
    ...
    public PayUStatusGateway(PayUCommonGateway common) {
        this.common = common;
