            ...
            for (String paymentCode : request.getPaymentGroups().get(paymentGroup)) {
                ...
                try {
                    ...
                    task = () -> {
                        ...
                        return userPreferredPaymentService.getUserPreferredPayments(PreferredPaymentDetailsRequest.builder().productDetails(request.getProductDetails()).preferredPayment(userPreferredPaymentMap.getOrDefault(keyBuilder.build(), UserPreferredPayment.builder().id(keyBuilder.build()).build())).build());
                    };
