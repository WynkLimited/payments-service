...
public class PayUPaymentVerifyTest {
    ...
    public void verifyValidVPA() {
        ...
        WynkResponseEntity<IVerificationResponse> verificationResponseWynkResponseEntity = verificationService.doVerify(VerificationRequest.builder().paymentCode(PaymentCodeCachingService.getFromPaymentCode(PAYU)).verificationType(VerificationType.VPA).verifyValue("valid_random_vpa").build());
    ...
    public void verifyInValidVPA() {
        ...
        WynkResponseEntity<IVerificationResponse> verificationResponseWynkResponseEntity = verificationService.doVerify(VerificationRequest.builder().paymentCode(PaymentCodeCachingService.getFromPaymentCode(PAYU)).verificationType(VerificationType.VPA).verifyValue("invalid_random_vpa").build());
        PayUVpaVerificationResponse payUResponse = gson.fromJson(verificationResponseWynkResponseEntity.getBody().getData().toString(), PayUVpaVerificationResponse.class);
        Assert.assertNotNull(payUResponse);
        Assert.assertEquals(verificationResponseWynkResponseEntity.getStatus(), HttpStatus.OK);
        Assert.assertEquals(payUResponse.getPayerAccountName(), payuVpaVerificationResponse.getPayerAccountName());
    ...
    public void verifyValidBIN() {
        ...
        WynkResponseEntity<IVerificationResponse> verificationResponseWynkResponseEntity = verificationService.doVerify(VerificationRequest.builder().paymentCode(PaymentCodeCachingService.getFromPaymentCode(PAYU)).verificationType(VerificationType.BIN).verifyValue("valid_random_bin").build());
    ...
    public void verifyInValidBIN() {
        ...
        WynkResponseEntity<IVerificationResponse> verificationResponseWynkResponseEntity = verificationService.doVerify(VerificationRequest.builder().paymentCode(PaymentCodeCachingService.getFromPaymentCode(PAYU)).verificationType(VerificationType.BIN).verifyValue("invalid_random_bin").build());
        PayUCardInfo responseBody = gson.fromJson(verificationResponseWynkResponseEntity.getBody().getData().toString(), PayUCardInfo.class);
        Assert.assertNotNull(responseBody);
        Assert.assertEquals(verificationResponseWynkResponseEntity.getStatus(), HttpStatus.OK);
        Assert.assertEquals(responseBody.getCardType(), cardInfo.getCardType());
